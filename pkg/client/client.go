...
type Client interface {
	...
	CredentialCreate(ctx context.Context, serverAddress, username, password string, skipValidate bool) (*apiv1.Credential, error)
	...
	CredentialUpdate(ctx context.Context, serverAddress, username, password string, skipValidate bool) (*apiv1.Credential, error)
