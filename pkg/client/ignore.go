...
func (c IgnoreUninstalled) CredentialCreate(ctx context.Context, serverAddress, username, password string, skipValidate bool) (*apiv1.Credential, error) {
	return promptInstall(ctx, func() (*apiv1.Credential, error) {
		return c.client.CredentialCreate(ctx, serverAddress, username, password, skipValidate)
	})
}
...
func (c IgnoreUninstalled) CredentialUpdate(ctx context.Context, serverAddress, username, password string, skipValidate bool) (*apiv1.Credential, error) {
	return c.client.CredentialUpdate(ctx, serverAddress, username, password, skipValidate)
}
