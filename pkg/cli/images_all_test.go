...
func TestImages(t *testing.T) {
	...
	image3Untagged := apiv1.Image{
		TypeMeta: metav1.TypeMeta{},
		ObjectMeta: metav1.ObjectMeta{
			Name:      "example.com/acc/Name3::image-3-129394",
			Namespace: "Name3",
		},
	}
	...
	allImagesHaveContainers := func(f *mocks.MockClient) {
