...
func (in *AppInstanceSpec) DeepCopyInto(out *AppInstanceSpec) {
	*out = *in
	...
	if in.WorkloadClass != nil {
		in, out := &in.WorkloadClass, &out.WorkloadClass
		*out = make(WorkloadClassMap, len(*in))
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in WorkloadClassMap) DeepCopyInto(out *WorkloadClassMap) {
	{
		in := &in
		*out = make(WorkloadClassMap, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkloadClassMap.
func (in WorkloadClassMap) DeepCopy() WorkloadClassMap {
	if in == nil {
		return nil
	}
	out := new(WorkloadClassMap)
	in.DeepCopyInto(out)
	return *out
}
