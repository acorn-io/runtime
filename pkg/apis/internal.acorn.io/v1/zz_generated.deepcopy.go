...
func (in *AppInstanceSpec) DeepCopyInto(out *AppInstanceSpec) {
	*out = *in
	...
	if in.ImageGrantedPermissions != nil {
		in, out := &in.ImageGrantedPermissions, &out.ImageGrantedPermissions
		*out = make([]Permissions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
func (in *AppInstanceStatus) DeepCopyInto(out *AppInstanceStatus) {
	*out = *in
	in.EmbeddedAppStatus.DeepCopyInto(&out.EmbeddedAppStatus)
...
func (in *AppSpec) DeepCopyInto(out *AppSpec) {
	*out = *in
	...
	if in.Assistants != nil {
		...
		*out = make(map[string]Assistant, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
func (in *AppStatusStaged) DeepCopyInto(out *AppStatusStaged) {
	*out = *in
	in.AppImage.DeepCopyInto(&out.AppImage)
	if in.AppScopedPermissions != nil {
		in, out := &in.AppScopedPermissions, &out.AppScopedPermissions
		*out = make([]Permissions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.PermissionsMissing != nil {
		in, out := &in.PermissionsMissing, &out.PermissionsMissing
		*out = make([]Permissions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ImagePermissionsDenied != nil {
		in, out := &in.ImagePermissionsDenied, &out.ImagePermissionsDenied
		*out = make([]Permissions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ImageAllowed != nil {
		in, out := &in.ImageAllowed, &out.ImageAllowed
		*out = new(bool)
		**out = **in
	}
}
...
func (in *Build) DeepCopyInto(out *Build) {
	*out = *in
	...
	if in.WatchFiles != nil {
		in, out := &in.WatchFiles, &out.WatchFiles
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContainerResolvedOffering) DeepCopyInto(out *ContainerResolvedOffering) {
	*out = *in
	if in.Memory != nil {
		in, out := &in.Memory, &out.Memory
		*out = new(int64)
...
func (in *ContainerResolvedOffering) DeepCopy() *ContainerResolvedOffering {
	if in == nil {
		return nil
	}
	out := new(ContainerResolvedOffering)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EmbeddedAppStatus) DeepCopyInto(out *EmbeddedAppStatus) {
	*out = *in
	...
	in.ResolvedOfferings.DeepCopyInto(&out.ResolvedOfferings)
	...
	if in.DeniedConsumerPermissions != nil {
		in, out := &in.DeniedConsumerPermissions, &out.DeniedConsumerPermissions
		*out = make([]Permissions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
func (in *ExpressionError) DeepCopyInto(out *ExpressionError) {
	*out = *in
	if in.DependencyNotFound != nil {
		in, out := &in.DependencyNotFound, &out.DependencyNotFound
		*out = new(DependencyNotFound)
		**out = **in
	}
}
...
func (in *ResolvedOfferings) DeepCopyInto(out *ResolvedOfferings) {
	*out = *in
	if in.Volumes != nil {
		in, out := &in.Volumes, &out.Volumes
		*out = make(map[string]VolumeResolvedOffering, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
	...
	if in.Containers != nil {
		in, out := &in.Containers, &out.Containers
		*out = make(map[string]ContainerResolvedOffering, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
func (in *ServiceStatus) DeepCopyInto(out *ServiceStatus) {
	*out = *in
	...
	if in.MissingConsumerPermissions != nil {
		in, out := &in.MissingConsumerPermissions, &out.MissingConsumerPermissions
		*out = make([]Permissions, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
func (in *VolumeResolvedOffering) DeepCopy() *VolumeResolvedOffering {
	if in == nil {
		return nil
	}
	out := new(VolumeResolvedOffering)
	in.DeepCopyInto(out)
	return out
}
