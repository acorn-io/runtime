...
func (in *AppStatus) DeepCopyInto(out *AppStatus) {
	*out = *in
	if in.DevSession != nil {
		...
		*out = new(internal_acorn_iov1.DevSessionInstanceSpec)
		(*in).DeepCopyInto(*out)
	}
...
func (in *Config) DeepCopyInto(out *Config) {
	*out = *in
	...
	if in.RequireComputeClass != nil {
		in, out := &in.RequireComputeClass, &out.RequireComputeClass
		*out = new(bool)
		**out = **in
	}
	if in.DisableUsageMetrics != nil {
		in, out := &in.DisableUsageMetrics, &out.DisableUsageMetrics
		*out = new(bool)
		**out = **in
	}
}
