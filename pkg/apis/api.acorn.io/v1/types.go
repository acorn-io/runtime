...
type Config struct {
	...
	LetsEncryptEmail             string         `json:"letsEncryptEmail" name:"lets-encrypt-email" usage:"Required if --lets-encrypt=production. The email address to use for Let's Encrypt (default '')"`
