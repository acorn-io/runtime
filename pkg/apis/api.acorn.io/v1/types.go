...
type Config struct {
	...
	ServiceLBAnnotations           map[string]string `json:"serviceLBAnnotations" name:"service-lb-annotations" usage:"Annotations to add to the service of type LoadBalancer. Defaults to empty. (example key=value)"`
}
